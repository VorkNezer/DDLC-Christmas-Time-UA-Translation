...
layeredimage yuri turned:
    at AutofocusDisplayable(name="yuri turned")
    ...
    group left:
        ...
        #hoodie
        attribute ldown default if_any(["rup","rcut"]) if_all(["hoodie"]):
            "mod_assets/MPT/yuri/hoodie_rdown.png"
    ...
    group right:
        ...
        attribute rdown default if_any(["hoodie"]):
            "mod_assets/MPT/yuri/hoodie_rdown.png"
        attribute rup if_any(["hoodie"]):
            "mod_assets/MPT/yuri/hoodie_rup.png"
    ...
    group left:#This is here a second time to deal with if the right half of Yuri is shown only down; the left half of her with her arm up has to render over the right half.
        ...
        attribute lup if_any(["rup","rcut"]) if_all(["hoodie"]):
            "mod_assets/MPT/yuri/hoodie_lup.png"
    ...
    group eyes:
        ...
        #Default Opened eyes:
        attribute oe default if_any(["sedu"]):
        ...
        attribute oe default if_any(["happ","angr","pout","neut","curi"]):
...
layeredimage yuri shy:
    at AutofocusDisplayable(name="yuri shy")
    ...
    group outfit:
        ...
        attribute hoodie:
            "mod_assets/MPT/yuri/hoodie_shy.png"
...
layeredimage yuri hoodie:
    at AutofocusDisplayable(name="yuri hoodie")
...
layeredimage yuri dress:
    at AutofocusDisplayable(name="yuri dress")
    ...
    group outfit:#These attributes are here only to determine which set of "body" sprites to use later.  "null" is what lets us just use these attributes as logic and nothing else.
        ...
        attribute ldown default:
            "mod_assets/MPT/yuri/dress_ldown.png"
        attribute lup:
            "mod_assets/MPT/yuri/dress_lup.png"
...
layeredimage yuri vampire:
    at AutofocusDisplayable(name="yuri vampire")
    ...
    group outfit:#These attributes are here only to determine which set of "body" sprites to use later.  "null" is what lets us just use these attributes as logic and nothing else.
        ...
        anchor (0,0) subpixel (True)
        attribute ldown default:
            "mod_assets/MPT/yuri/ddlc_vamp_yuri_1.png"
        attribute lup:
            "mod_assets/MPT/yuri/ddlc_vamp_yuri_2.png"
        attribute lcross:
            "mod_assets/MPT/yuri/ddlc_yuri_arm_.png"
...
image yuri shadow = im.Composite((960, 960), (0, 0), "mod_assets/MPT/yuri/shadow_dress.png")